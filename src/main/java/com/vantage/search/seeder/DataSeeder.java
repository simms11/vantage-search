...
public class DataSeeder implements CommandLineRunner {
    ...
    /**
     * Vector-store seeding hits Ollama over HTTP. Runs outside any DB transaction
     * so a slow LLM call does not pin a Postgres connection.
     */
    void seedVectorStoreIfMissing() {
